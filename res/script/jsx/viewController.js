...
function loadButton() {
    var renNewButton = React.createElement(
        "div",
        { className: "toCenter" },
        React.createElement(ControlButton, { color: "#FEDFE1", fun: playVocal, name: "重复", simpleName: "V" }),
        React.createElement(ControlButton, { color: "#FB966E", fun: autoNext, name: "自动", simpleName: "A", id: "autoButton" }),
        React.createElement(ControlButton, { color: "#FBE251", fun: fastNext, name: "快进", simpleName: "F", id: "fastButton" }),
        React.createElement(ControlButton, { color: "#A5DEE4", fun: onSaveGame, name: "存档", simpleName: "S" }),
        React.createElement(ControlButton, { color: "#58B2DC", fun: onLoadGame, name: "读档", simpleName: "L" }),
        React.createElement(ControlButton, { color: "#B28FCE", fun: onSetting, name: "设置", simpleName: "C" }),
        React.createElement(ControlButton, { color: "#BDC0BA", fun: Title, name: "标题", simpleName: "T" })
    );
...
function playVocal() {
    ...
    if (vocalName === '') {
        ReactDOM.render(React.createElement("div", null), document.getElementById('vocal'));
        return;
    }
